...
namespace backend.Src.Domain.Entities
{
    public class User
    {
        ...
        public User(Guid id, string firstName, string lastName, Email email, UserRole role, string passwordHash, DateTime createdAt, bool isActive, DateTime lastUpdate, DateTime lastLogin)
        {
