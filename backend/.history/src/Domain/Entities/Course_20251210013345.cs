...
namespace backend.Src.Domain.Entities
{
    public class Course
    {
        ...
        public void Publish()
        {
            if (!_lessons.Any()) throw new ArgumentException("Course must have at least one lesson to publish.");
            IsPublished = true;
        }
        ...
        {
            if (string.IsNullOrWhiteSpace(title)) throw new ArgumentException("Lesson title required.");
        ...
        public void RemoveLesson(Guid lessonId)
        {
            ...
            if (existing == null) throw new ArgumentException("Lesson not found.");
